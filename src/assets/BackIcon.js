...
export const BackIcon = ({forceleft, toggleAction}) => (
  <span style={{ marginLeft: forceleft ? '0px' :'6px', display:'flex', justifyContent: forceleft ? "start" :'center', alignItems: 'center', cursor: "pointer" }}
    onClick={()=>toggleAction ? toggleAction() : ""}
  >
