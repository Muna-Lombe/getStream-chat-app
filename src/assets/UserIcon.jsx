...
export const UserIcon = ({ onClick, size = { w: null, h: null },disabled}) => {
  return (
    <span aria-disabled={disabled || false}>
      <svg version="1.1" id="user-icon"  
        x="0px" y="0px"
        width={size.w || 16}
        height={size.h || 16}
        ...
        <g>
          <g>
			...
			c0,18.178-8.896,33.756-21.555,40.361l1.19,6.349c10.019,11.658,49.802,12.418,49.802,58.488H150.453z" fill="#005fff" fillOpacity={disabled ?35 : 100}/>
          </g>
        </g>
      </svg>
    </span>
